export enum Commands {
  ...
  SetRegionSelectorPassthrough = "set_region_selector_passthrough",
  SetRegionSelectorOpacity = "set_region_selector_opacity",
  TakeDisplayScreenshot = "take_display_screenshot",
